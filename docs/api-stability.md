...
experimental precision recommendations may evolve in backward-compatible ways.
...
Independent real-world project validation remains ongoing after 1.0. The
controlled regression and benchmark fixtures are deliberately not presented as
a substitute for broader ecosystem evidence.
